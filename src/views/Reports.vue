...
/* ─────────────────────────────────────────
   STATE — shared
───────────────────────────────────────── */
const activeTab = ref<'attendance' | 'punctuality' | 'tardiness' | 'payslip' | 'remittances'>(
  'attendance',
)
                      ...
                      <div class="d-flex align-center gap-1">
                        ...
                        >
                          ...
                          <span>
                            ...
                            <template v-if="item.pass_slip_late_minutes > 0">
                              + pass slip:
                              {{
                    ...
                    <template #item.total_absent_days="{ item }">
                      <div class="d-flex align-center gap-1">
                        ...
                        >
                          ...
                          {{ item.dtr_absent_days - item.total_absent_days }}
                          leave/travel = {{ item.total_absent_days }} day(s)
                        </VTooltip>
                      </div>
                    </template>
                  </VDataTable>
              ...
              >
                <VCardText class="text-center py-8">
                  ...
                  <p class="text-body-1 text-medium-emphasis">
                    Select a period and click <strong>Load Summary</strong> to
                    view saved DTR data.
                  </p>
                  <p class="text-caption text-medium-emphasis mt-2">
                    Make sure DTR has been saved for the selected period from
                    the DTR module.
                  </p>
                </VCardText>
              </VCard>
                ...
                <VCardText>
                  ...
                  >
                    ...
                    <span class="text-caption text-medium-emphasis">
                      — Absence(s) fully offset by approved Leave or Official
                      Travel
                    </span>
                  </div>
                </VCardText>
            ...
            >
              ...
              >
                <VCardText class="text-center py-8">
                  ...
                  <p class="text-caption text-medium-emphasis mt-2">
                    Employees with zero unjustified absences, zero tardiness,
                    and zero undertime will appear here, grouped by division.
                    Absences covered by Leave/Official Travel are included and
                    flagged.
                  </p>
                </VCardText>
              </VCard>
              ...
              >
                <VCardText>
                  ...
                  >
                    ...
                    <span class="text-caption text-medium-emphasis">
                      — Late minutes include pass-slip adjustment(s) not
                      captured in DTR
                    </span>
                  </div>
                </VCardText>
                  ...
                  <div class="d-flex align-center justify-space-between flex-wrap gap-3 mb-3">
                    <div>
                      ...
                      <p class="text-caption text-medium-emphasis mt-1">
                        ...
                        >
                          {{
                            filteredPayslipEmployees.filter((e) => e.has_batch)
                              .length
                          }}
                          payroll ready
                        </VChip>
                        <VChip
                          v-if="
                            filteredPayslipEmployees.filter(
                              (e) => !e.has_batch && e.batch_count > 0,
                            ).length
                          "
                          color="warning"
                          size="x-small"
            ...
            >
              ...
              >
                <VCardText class="text-center py-8">
                  ...
                  />
                  <p class="text-body-1 text-medium-emphasis">
                    Select a period and click <strong>Load Data</strong> to
                    begin.
                  </p>
                  <p class="text-caption text-medium-emphasis mt-2">
                    Only employees with a <strong>finalized</strong> payroll
                    batch for the selected period will appear here.
                  </p>
                </VCardText>
              </VCard>
            </VCol>
